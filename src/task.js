...
document
  .querySelector(".cancel-form-task")
  .addEventListener("click", () => dialog.close());

document
  .querySelector(".close-task-info")
...
export function showTaskInfo(todoList, taskID) {
  ...
  document.querySelector(".task-name-modal").textContent = task.title;

  document.querySelector(".task-duedate-modal").textContent = task.dueDate;

  document.querySelector(".task-notes-modal").textContent = task.notes;
